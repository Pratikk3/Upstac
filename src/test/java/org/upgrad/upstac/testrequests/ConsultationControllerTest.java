...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        assertNotNull(testRequest.getConsultation());
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        consultationController.updateConsultation(testRequest1.getRequestId(),createConsultationRequest);
        ...
        assertThat(testRequest.getConsultation().getSuggestion(),equalTo(testRequest1.getConsultation().getSuggestion()));
    ...
    public CreateConsultationRequest getCreateConsultationRequest(TestRequest testRequest) {
        ...
        createConsultationRequest.setSuggestion(testRequest.getConsultation().getSuggestion());
        createConsultationRequest.setComments(testRequest.getConsultation().getComments());
        ...
        if(testRequest.getLabResult().getResult()==TestStatus.POSITIVE)
        {
            ...
            createConsultationRequest.setComments(" for 14 Days qurantine at home");
        }
